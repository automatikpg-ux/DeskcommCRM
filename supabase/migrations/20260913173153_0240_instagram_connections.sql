-- 0240 · A conta do Instagram de CADA LEAD, conectada.
--
-- `instagram_apps` (0239) guarda o App que faz a ponte com a Meta — um por
...
-- Mesmo motivo de `instagram_apps` (0239) e `ad_platform_connections` (0213):
