...
describe("a matriz de plataformas é exaustiva", () => {
  ...
  it("google_ads TEM transporte desde a migration 0263 — antes só faltava a credencial", async () => {
    // 0263 fechou a credencial (refresh token OAuth + os três identificadores
    // de para onde reportar). `transporteDe("google_ads")` deixou de ser o
    // `null` declarado — ver `lib/plataformas-de-anuncio/registry.ts`.
